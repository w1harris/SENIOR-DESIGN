...
// This code was pulled from ai85-cough
// ai85-cough was @generated by ai8xize.py --verbose --test-dir demos --prefix ai85-cough --checkpoint-file trained/qat_best_q8.pth.tar --config-file networks/kws20-v3-hwc.yaml --device MAX78000 --compact-weights --softmax --overwrite
...
// Expected output of layer 8 for ai85-cough given the sample input (known-answer test)
...
void init_ML(){
  ...
  /* MAY NEED TO ADD THIS BACK IN, FROM ORIGINAL MAIN FUNCITON
